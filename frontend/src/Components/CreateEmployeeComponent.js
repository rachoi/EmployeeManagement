...
class CreateEmployeeComponent extends Component {
    ...
    saveOrUpdateEmployee = (e) => {
        e.preventDefault();
        let employee = {firstName: this.state.firstName, lastName: this.state.lastName, emailId: this.state.emailId, lastClockedIn: this.state.lastClockedIn, lastClockedOut: this.state.lastClockedOut, isClockedIn: this.state.isClockedIn};
